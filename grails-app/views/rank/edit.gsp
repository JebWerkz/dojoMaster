...
<html>
	...
	<body>
		<a href="#edit-rank" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-rank" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:rankInstance, action:'update']" method="PUT" >
