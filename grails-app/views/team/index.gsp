		...
		<div id="list-team" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="color" title="${message(code: 'team.color.label', default: 'Color')}" />
				...
				<g:each in="${teamInstanceList}" status="i" var="teamInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${teamInstance.id}">${fieldValue(bean: teamInstance, field: "color")}</g:link></td>
